...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ShockwaveDemo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ShockwaveDemo", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "5";
		app.meta["company"] = "Matse";
		app.meta["file"] = "ShockwaveDemo";
		app.meta["name"] = "ShockwaveDemo";
		app.meta["packageName"] = "ShockwaveDemo";
		...
		#elseif !air
		app.window.context.attributes.background = 13421772;
